 ...
 *****************************************************************************/
var $ = require("jquery");
var cdsM = require("./cds");
var cds = require("./cds").cds;
var CooFrameEnum = require("./CooFrameEnum");
var Coo = require("./Coo");
var MeasurementTable = require("./MeasurementTable");
var Location = require("./Location");
var Logger = require("./Logger");
var View = require("./View");
var Popup = require("./Popup");
var HealpixGrid = require("./HealpixGrid");
var HpxImageSurvey = require("./HpxImageSurvey");
var HealpixCache = require("./HealpixCache");
var ProjectionEnum = require("./ProjectionEnum");
...
Aladin = (function() {
  ...
  var Aladin = function(aladinDiv, requestedOptions) {
    ...
    var cooFrame = CooFrameEnum.fromString(
      options.cooFrame,
      CooFrameEnum.J2000
    );
  ...
  Aladin.prototype.showLayerBox = function() {
    ...
    for (var k = layers.length - 1; k >= 0; k--) {
      ...
      var rgbColor = $("<div></div>")
        .css("color", layer.color)
        .css("color"); // trick to retrieve the color as 'rgb(,,)' - does not work for named colors :(
