...
HpxKey = (function() {
  ...
  HpxKey.createHpxKeyfromAncestor = function(father, childNb) {
    var hpxKey = new HpxKey(
      ...
      father.width / 2,
      father.height / 2,
      childNb == 2 || childNb == 3 ? father.dx + father.width / 2 : father.dx,
      childNb == 1 || childNb == 3 ? father.dy + father.height / 2 : father.dy,
  ...
  HpxKey.prototype = {
    draw: function(ctx, view) {
      ...
      var updateNeededTiles =
        this.ancestor == null &&
        this.norder >= 3 &&
        now - this.hips.lastUpdateDateNeededTiles > 0.1;
    ...
    drawChildren: function(ctx, view, maxParente) {
      ...
      if (
        this.width > 1 &&
        this.norder < limitOrder &&
        this.parente < maxParente
      ) {
